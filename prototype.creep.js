...
Creep.prototype.borderCheck = function () {
    if (this.pos.x === 0 || this.pos.y === 0 || this.pos.x === 49 || this.pos.y === 49) {
        if (this.pos.x === 0 && this.pos.y === 0) {
            this.tryMoveOneOf([BOTTOM_RIGHT]);
        }
        else if (this.pos.x === 0 && this.pos.y === 49) {
            this.tryMoveOneOf([TOP_RIGHT]);
        }
        else if (this.pos.x === 49 && this.pos.y === 0) {
            this.tryMoveOneOf([BOTTOM_LEFT]);
        }
        else if (this.pos.x === 49 && this.pos.y === 49) {
            this.tryMoveOneOf([TOP_LEFT]);
        }
        else if (this.pos.x === 49) {
            this.tryMoveOneOf([LEFT, TOP_LEFT, BOTTOM_LEFT])
        }
        else if (this.pos.x === 0) {
            this.tryMoveOneOf([RIGHT, TOP_RIGHT, BOTTOM_RIGHT])
        }
        else if (this.pos.y === 0) {
            this.tryMoveOneOf([BOTTOM, BOTTOM_RIGHT, BOTTOM_LEFT])
        }
        else if (this.pos.y === 49) {
            this.tryMoveOneOf([TOP, TOP_RIGHT, TOP_LEFT])
        }
        return true;
    }
};

Creep.prototype.tryMoveOneOf = function (directions) {
    ...
    console.log(this.name + ' stuck in room ' + this.room.name + ' at x: ' + this.pos.x + ' y: ' + this.pos.y)
};
