...
function role(creep) {
    ...
    if (creep.memory.destinationReached === true || creep.memory.hauling === true) {
        if (creep.memory.hauling === false) {
            if (!creep.memory.containerID) {
                ...
                if (container.length > 0) {
                    ...
                    creep.shibMove(new RoomPosition(25, 25, creep.memory.destination), {range: 20, offRoad: true, returnIncomplete: true});
                }
            } else {
            ...
            if (creep.pos.roomName === creep.memory.overlord) {
                ...
                creep.shibMove(new RoomPosition(25, 25, creep.memory.overlord), {range: 23, ignoreRoads: true, returnIncomplete: true});
            }
        }
        ...
        creep.shibMove(new RoomPosition(25, 25, creep.memory.overlord), {range: 18, offRoad: true, returnIncomplete: true});
    }
}
